...
os.makedirs("IL/DME_TD3", exist_ok=True)
os.makedirs("IL/TD3_POLICY", exist_ok=True)
...
agent.save("IL/TD3_POLICY/td3_with_learned_reward_rot_0.5_0.01_IRL_")
print("Modello TD3 salvato.")